...
| [`naming-charter.md`](naming-charter.md) | *What is each thing called, and how do the axes relate?* — the canonical vocabulary + the `family`/`nature`/`archetype` collapse; settled once pre-1.0, then frozen (**Proposed**) | — | to look up the canonical term for a concept, or before proposing any rename |
