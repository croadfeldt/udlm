...
**Background — read first (the cold reader's on-ramp; skip if you have the context).** [ADR-026 — typed-classification naming](README.md); `docs/spec/foundations/entity-types.md`; `docs/spec/foundations/entity-type-families.md`; DCM ADR-013 (hardware component scope)
