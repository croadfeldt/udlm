...
**Realized by:** `registry/policy.schema.json` (`schedule`) · `registry/tools/validate.py` (`check_schedule_clauses`) · `registry/examples/example-policy-change-window.yaml`
**Date:** 2026-07-27
