...
| [031](ADR-031-one-zero-scope-focus.md) | 0.1 scope + focus — the 21 September use cases are the sole gravity well for 0.1 implementation; everything else is a minimal operational unblock or a Proposed ADR (binds nothing); remaining = ratify ADRs + conformance + 0.1→1.0 restamp | Accepted |
