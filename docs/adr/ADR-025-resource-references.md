...
## Options considered
- **Keep uuid-authoritative, resolve-at-intent for resource references** (status quo) — rejected: too rigid for live resources; forbids claim-before-define and out-of-order authoring; mismatches the DCM implementation and K8s.
