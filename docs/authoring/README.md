...
| A **profile** (an activatable posture — built-in or your own) | [`profile.md`](profile.md) | `profile.schema.json` | validate.py `check_profile`, check_urf, identity integrity |
