...
| 004 Provider capability declaration | generalize provider declaration into a capability declaration | **Ready** | Exercised by the provider-registration UC + §8.1a advertisement |
