...
| 2 | Tombstone/two-phase delete | DEP-007 + estate validator retire-first gate (roadfeldt-dcm) |
| 3 | Constrained reference topology | DEP-008 + estate validator TOPO-* checks (roadfeldt-dcm) |
