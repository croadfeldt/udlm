...
[`docs/spec/foundations/resource-service-entities.md`](../spec/foundations/resource-service-entities.md)
...
[`docs/spec/contracts/event-catalog.md`](../spec/contracts/event-catalog.md). Subscribe to the
...
See [`docs/spec/contracts/identifier-scheme.md`](../spec/contracts/identifier-scheme.md) for the
...
See [`docs/spec/contracts/time-and-clock.md`](../spec/contracts/time-and-clock.md).
...
- `error_code` — a stable identifier in a closed vocabulary
  (see [`docs/spec/contracts/error-model.md`](../spec/contracts/error-model.md)). Match on this
...
See [`docs/spec/contracts/retry-semantics.md`](../spec/contracts/retry-semantics.md).
...
See [`docs/spec/contracts/rate-limit-and-backpressure.md`](../spec/contracts/rate-limit-and-backpressure.md).
...
[`docs/spec/contracts/schema-sharing.md`](../spec/contracts/schema-sharing.md).
...
See [`docs/spec/lifecycle/request-dependency-graph.md`](../spec/lifecycle/request-dependency-graph.md).
...
See [`docs/spec/lifecycle/scheduled-requests.md`](../spec/lifecycle/scheduled-requests.md).
...
See [`docs/spec/lifecycle/operational-models.md`](../spec/lifecycle/operational-models.md).
...
1. [`docs/spec/foundations/four-states.md`](../spec/foundations/four-states.md) — the lifecycle
   in detail
2. [`docs/spec/foundations/resource-service-entities.md`](../spec/foundations/resource-service-entities.md) —
   the entity model
3. [`docs/spec/contracts/event-catalog.md`](../spec/contracts/event-catalog.md) — what events
   you can subscribe to
4. [`docs/spec/contracts/error-model.md`](../spec/contracts/error-model.md) — the full closed
   error vocabulary
5. [`docs/spec/foundations/examples.md`](../spec/foundations/examples.md) — worked examples
