...
- **[docs/guides/implementing-a-resource-type.md](implementing-a-resource-type.md)** — a worked, end-to-end walkthrough of building provider support for one type (`Machine.VM`), each step citing the obligation that governs it, with a "could you build from this?" self-test.
