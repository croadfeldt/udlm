...
**2 · Naturalize the intent** — provider-contract §2, [`data-roles.md`](../spec/contracts/data-roles.md). Translate
...
- [ ] Read `compute.vm.json (generated — authored in registry/classes/resource/compute/vm/_base.yaml)` **offline** and know every field's shape and every typed output.
