...
The `coverage:` block is your entry point to intended behavior. On `Machine.VM`, for
...
- `thing@version` (e.g. `type:Machine.VM@0.6.4`) — human-legible; resolves to a recorded
