...
- **`entity-types.md`** — the entity families (Resource, Process) and the single/multi shape (`entity_type`), and their data models. *Owns:* the entity-type taxonomy, `ENT-*` entity-type invariants.
