...
abstractions (**Data / Provider / Policy**, `docs/spec/foundations/foundations.md`) and the Layers-vs-Policies
distinction (`docs/spec/foundations/layering-and-versioning.md` §1a), and they settle the recurring design
...
translation's ramifications (`docs/spec/foundations/context-and-purpose.md` §7.1; DCM ADR-023).
...
records this as DCM ADR-023). The substrate carries conformant data in and conformant data out —
...
[`docs/spec/foundations/context-and-purpose.md`](../foundations/context-and-purpose.md) §7.1.
