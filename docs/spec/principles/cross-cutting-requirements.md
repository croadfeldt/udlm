...
(`docs/spec/foundations/four-states.md`), layering & versioning (`docs/spec/foundations/layering-and-versioning.md`),
...
- **Provenance / admission (Proposed — [ADR-057](../../adr/ADR-057-sovereignty-placement-and-provenance.md)).**
...
- **G2 — No embedded expressions; the contract layer is deterministic.** The
  determinism-is-structural principle is `core-tenets.md` T2/T3 (the portable model carries no embedded
