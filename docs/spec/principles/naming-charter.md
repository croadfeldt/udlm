...
flowchart TD
    ...
    RT["resource_type — the specific type (orthogonal, finest)<br/>Machine.VM · Automation.AnsiblePlaybook · …"]:::orth
...
| **resource_type** | `Machine.VM`, … | the **specific** type | **keep** — orthogonal, finest |
