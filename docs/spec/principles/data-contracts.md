...
UDLM tracks every resource through four lifecycle domains. The domains themselves — what each represents and how they relate — are defined canonically in [`docs/spec/foundations/four-states.md`](../foundations/four-states.md); this section states only the **persistence invariants** the substrate places on them.
