...
> **Full specification:** See [Composite Service Composition Model](../foundations/composite-service-model.md) for the complete contract, four-state model, failure propagation, compensation, and system policies (CMP-001–CMP-008).
...
**Capability declaration extension (summary — full schema in [composite-service-model.md](../foundations/composite-service-model.md)):**
```yaml
