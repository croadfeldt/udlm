...
- [ADR-005 — Time integrity](../../adr/ADR-005-time-integrity.md) — the decision this contract implements
...
- [ADR-PROV-002](../../adr/README.md) — the capability model `TimeSync` uses
