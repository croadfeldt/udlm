...
credential_record:
  ...
  scope:
    ...
    resource_types: [Machine.VM]                     # scoped resource types
...
Consumer requests resource (e.g., Machine.VM)
  ...
  │     scope.resource_types: [Machine.VM]
