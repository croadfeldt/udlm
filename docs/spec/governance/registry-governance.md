...
**Tier 1 examples:** `Machine.VM`, `Network.VLAN`, `Network.IPAddress`, `Storage.Block`, `Storage.File`, `Container.Pod`
...
([`docs/spec/contracts/error-model.md`](../contracts/error-model.md) §6a).
