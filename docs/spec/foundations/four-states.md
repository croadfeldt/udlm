...
**Related Documents:** [Context and Purpose](context-and-purpose.md) | [Entity Relationships](entity-relationships.md) | [data stores](../contracts/storage-providers.md) | [Audit, Provenance, and Observability](../contracts/audit-provenance-observability.md)
...
|-------|---------------------------|--------------|
| **Intent** | `{entity_uuid: …a1b2, resource_type: Machine.VM, cpu: 4, memory: 16GiB, network: "app-tier"}` — the consumer's raw ask, nothing added. | consumer (PR / API ingress) |
