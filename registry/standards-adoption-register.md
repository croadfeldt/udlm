...
**Covers:** `SLSA` `in-toto` · **Body:** OpenSSF / CNCF · **Since:** 2026-07-14 · **Where:** per-hop re-attestation down the fulfillment graph (accreditation-and-authorization-matrix.md §3.3.1, matrix §3.3.1) = in-toto's **layout step MATCH** at each link; delegation (matrix §3.9) ≈ SLSA **VSA** (Verification Summary Attestation — "someone I trust already verified this").
