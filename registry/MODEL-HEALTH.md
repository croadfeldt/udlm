...
| Discrimination density | 3568/3568 = 100.00% | mutations rejected / attempted; 0 finding(s) |
...
| UC coverage | 16/48 (33%) | types appearing in >=1 use case (127 UC files scanned) |
...
Types appearing in no use case (32) — each is either ahead of its
