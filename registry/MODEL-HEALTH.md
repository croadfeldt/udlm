...
| Discrimination density | 3400/3400 = 100.00% | mutations rejected / attempted; 0 finding(s) |
...
| UC coverage | 15/48 (31%) | types appearing in >=1 use case (124 UC files scanned) |
...
Types appearing in no use case (33) — each is either ahead of its
