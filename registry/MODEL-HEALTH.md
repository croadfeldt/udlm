...
| Discrimination density | 278/278 = 100.00% | mutations rejected / attempted; 0 finding(s) |
...
| UC coverage | 3/47 (6%) | types appearing in >=1 use case (22 UC files scanned) |
...
Types appearing in no use case (44) — each is either ahead of its
